...
void TokenData::get (std::map<std::string, TokenData>& tokenData) {
  ...
  tokenData["lea"] = TokenData (Token::Type::LOAD, TOKEN_SUBTYPE_LEA);
  tokenData["les"] = TokenData (Token::Type::LOAD, TOKEN_SUBTYPE_LES);
  tokenData["lds"] = TokenData (Token::Type::LOAD, TOKEN_SUBTYPE_LDS);
  tokenData["in"] = TokenData (Token::Type::IN, 0);
  tokenData["out"] = TokenData (Token::Type::OUT, 0);
  tokenData["call"] = TokenData (Token::Type::JMP, TOKEN_SUBTYPE_CALL);
  tokenData["jmp"] = TokenData (Token::Type::JMP, TOKEN_SUBTYPE_JMP);
  tokenData["loopnz"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_LOOPNZ);
  tokenData["loopne"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_LOOPNZ);
  tokenData["loopz"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_LOOPZ);
  tokenData["loope"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_LOOPZ);
  tokenData["loop"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_LOOP);
  tokenData["jcxz"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JCXZ);
  tokenData["jo"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JO);
  tokenData["jno"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JNO);
  tokenData["jb"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JB);
  tokenData["jc"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JB);
  tokenData["jnae"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JB);
  tokenData["jnb"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JNB);
  tokenData["jnc"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JNB);
  tokenData["jae"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JNB);
  tokenData["jz"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JZ);
  tokenData["je"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JZ);
  tokenData["jnz"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JNZ);
  tokenData["jne"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JNZ);
  tokenData["jbe"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JBE);
  tokenData["jna"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JBE);
  tokenData["ja"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JA);
  tokenData["jnbe"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JA);
  tokenData["js"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JS);
  tokenData["jns"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JNS);
  tokenData["jpe"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JPE);
  tokenData["jp"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JPE);
  tokenData["jpo"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JPO);
  tokenData["jnp"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JPO);
  tokenData["jl"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JL);
  tokenData["jnge"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JL);
  tokenData["jge"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JGE);
  tokenData["jnl"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JGE);
  tokenData["jle"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JLE);
  tokenData["jng"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JLE);
  tokenData["jg"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JG);
  tokenData["jnle"] = TokenData (Token::Type::CONDITIONAL_JMP, TOKEN_SUBTYPE_JG);
