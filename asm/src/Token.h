...
public:
  enum class Type {
    SEGREG, REG, INSTR0, INSTR01, INSTR1, INSTR2, LOAD, IN, OUT, INT, JMP, CONDITIONAL_JMP,
    PTR_TYPE, PTR, FAR, DB, IDENTIFIER, NUMBER, STRING, OPERATOR, EQUALS, COMMA, COLON,
    LEFT_PARENTHESIS, RIGHT_PARENTHESIS, LEFT_BRACKET, RIGHT_BRACKET, UNDEFINED
  };
